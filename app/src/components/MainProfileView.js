                    ...
                    <div className="content cont-main" id="content">
                        ...
                        <div className="row no-gutters">
                            <div className="left-items-group">
                                <div className="item">
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['head']) ? 'text-quality-' + profileData.items['head'].quality : ''}>{(profileData.items['head']) ? profileData.items['head'].name : ''}</span></h3>
                                        </div>
                                    ...
                                    <a href={(profileData.items['head']) ? this.getItemLink(profileData.items['head']) : ""}>
                                        <div className={(profileData.items['head']) ? 'item-img img-quality-' + profileData.items['head'].quality : 'item-img'}
                                             style={{backgroundImage: `url(${(profileData.items['head']) ? this.getItemImage(profileData.items['head']) : '/images/emptyslots/head.gif'})`}}/>
                                    </a></div>
                                <div className="item">
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['neck']) ? 'text-quality-' + profileData.items['neck'].quality : ''}>{(profileData.items['neck']) ? profileData.items['neck'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                    ...
                                    <a href={(profileData.items['neck']) ? this.getItemLink(profileData.items['neck']) : ""}>
                                        <div className={(profileData.items['neck']) ? 'item-img img-quality-' + profileData.items['neck'].quality : 'item-img'}
                                             style={{backgroundImage: `url(${(profileData.items['neck']) ? this.getItemImage(profileData.items['neck']) : '/images/emptyslots/neck.gif'})`}}/>
                                    </a></div>
                                <div className="item">
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['shoulder']) ? 'text-quality-' + profileData.items['shoulder'].quality : ''}>{(profileData.items['shoulder']) ? profileData.items['shoulder'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                    ...
                                    <a href={(profileData.items['shoulder']) ? this.getItemLink(profileData.items['shoulder']) : ""}>
                                        <div className={(profileData.items['shoulder']) ? 'item-img img-quality-' + profileData.items['shoulder'].quality : 'item-img'}
                                ...
                                <div className="item">
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['back']) ? 'text-quality-' + profileData.items['back'].quality : ''}>{(profileData.items['back']) ? profileData.items['back'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                    ...
                                    <a href={(profileData.items['back']) ? this.getItemLink(profileData.items['back']) : ""}>
                                        <div className={(profileData.items['back']) ? 'item-img img-quality-' + profileData.items['back'].quality : 'item-img'}
                                             style={{backgroundImage: `url(${(profileData.items['back']) ? this.getItemImage(profileData.items['back']) : '/images/emptyslots/back.gif'})`}}/>
                                    </a></div>
                                <div className="item">
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['chest']) ? 'text-quality-' + profileData.items['chest'].quality : ''}>{(profileData.items['chest']) ? profileData.items['chest'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                    ...
                                    <a href={(profileData.items['chest']) ? this.getItemLink(profileData.items['chest']) : ""}>
                                        <div className={(profileData.items['chest']) ? 'item-img img-quality-' + profileData.items['chest'].quality : 'item-img'}
                                             style={{backgroundImage: `url(${(profileData.items['chest']) ? this.getItemImage(profileData.items['chest']) : '/images/emptyslots/chest.gif'})`}}/>
                                    </a></div>
                                <div className="item">
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['shirt']) ? 'text-quality-' + profileData.items['shirt'].quality : ''}>{(profileData.items['shirt']) ? profileData.items['shirt'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                    ...
                                    <a href={(profileData.items['shirt']) ? this.getItemLink(profileData.items['shirt']) : ""}>
                                        <div className={(profileData.items['shirt']) ? 'item-img img-quality-' + profileData.items['shirt'].quality : 'item-img'}
                                             style={{backgroundImage: `url(${(profileData.items['shirt']) ? this.getItemImage(profileData.items['shirt']) : '/images/emptyslots/shirt.gif'})`}}/>
                                    </a></div>
                                <div className="item">
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['tabard']) ? 'text-quality-' + profileData.items['tabard'].quality : ''}>{(profileData.items['tabard']) ? profileData.items['tabard'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                    ...
                                    <a href={(profileData.items['tabard']) ? this.getItemLink(profileData.items['tabard']) : ""}>
                                        <div className={(profileData.items['tabard']) ? 'item-img img-quality-' + profileData.items['tabard'].quality : 'item-img'}
                                ...
                                <div className="item">
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['wrist']) ? 'text-quality-' + profileData.items['wrist'].quality : ''}>{(profileData.items['wrist']) ? profileData.items['wrist'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                    ...
                                    <a href={(profileData.items['wrist']) ? this.getItemLink(profileData.items['wrist']) : ""}>
                                        <div className={(profileData.items['wrist']) ? 'item-img img-quality-' + profileData.items['wrist'].quality : 'item-img'}
                            ...
                            <div className="right-items-group">
                                <div className="item"><a href={(profileData.items['hands']) ? this.getItemLink(profileData.items['hands']) : ""}>
                                    <div className={(profileData.items['hands']) ? 'item-img img-quality-' + profileData.items['hands'].quality : 'item-img'}
                                         style={{backgroundImage: `url(${(profileData.items['hands']) ? this.getItemImage(profileData.items['hands']) : '/images/emptyslots/hands.gif'})`}}/>
                                </a>
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['hands']) ? 'text-quality-' + profileData.items['hands'].quality : ''}>{(profileData.items['hands']) ? profileData.items['hands'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                ...
                                <div className="item"><a href={(profileData.items['waist']) ? this.getItemLink(profileData.items['waist']) : ""}>
                                    <div className={(profileData.items['waist']) ? 'item-img img-quality-' + profileData.items['waist'].quality : 'item-img'}
                                         style={{backgroundImage: `url(${(profileData.items['waist']) ? this.getItemImage(profileData.items['waist']) : '/images/emptyslots/waist.gif'})`}}/>
                                </a>
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['waist']) ? 'text-quality-' + profileData.items['waist'].quality : ''}>{(profileData.items['waist']) ? profileData.items['waist'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                ...
                                <div className="item"><a href={(profileData.items['legs']) ? this.getItemLink(profileData.items['legs']) : ""}>
                                    <div className={(profileData.items['legs']) ? 'item-img img-quality-' + profileData.items['legs'].quality : 'item-img'}
                                         style={{backgroundImage: `url(${(profileData.items['legs']) ? this.getItemImage(profileData.items['legs']) : '/images/emptyslots/legs.gif'})`}}/>
                                </a>
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['legs']) ? 'text-quality-' + profileData.items['legs'].quality : ''}>{(profileData.items['legs']) ? profileData.items['legs'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                ...
                                <div className="item"><a href={(profileData.items['feet']) ? this.getItemLink(profileData.items['feet']) : ""}>
                                    <div className={(profileData.items['feet']) ? 'item-img img-quality-' + profileData.items['feet'].quality : 'item-img'}
                                         style={{backgroundImage: `url(${(profileData.items['feet']) ? this.getItemImage(profileData.items['feet']) : '/images/emptyslots/feet.gif'})`}}/>
                                </a>
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['feet']) ? 'text-quality-' + profileData.items['feet'].quality : ''}>{(profileData.items['feet']) ? profileData.items['feet'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                ...
                                <div className="item"><a href={(profileData.items['finger1']) ? this.getItemLink(profileData.items['finger1']) : ""}>
                                    <div className={(profileData.items['finger1']) ? 'item-img img-quality-' + profileData.items['finger1'].quality : 'item-img'}
                                    ...
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['finger1']) ? 'text-quality-' + profileData.items['finger1'].quality : ''}>{(profileData.items['finger1']) ? profileData.items['finger1'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                ...
                                <div className="item"><a href={(profileData.items['finger2']) ? this.getItemLink(profileData.items['finger2']) : ""}>
                                    <div className={(profileData.items['finger2']) ? 'item-img img-quality-' + profileData.items['finger2'].quality : 'item-img'}
                                    ...
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['finger2']) ? 'text-quality-' + profileData.items['finger2'].quality : ''}>{(profileData.items['finger2']) ? profileData.items['finger2'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                ...
                                <div className="item"><a href={(profileData.items['trinket1']) ? this.getItemLink(profileData.items['trinket1']) : ""}>
                                    <div className={(profileData.items['trinket1']) ? 'item-img img-quality-' + profileData.items['trinket1'].quality : 'item-img'}
                                    ...
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['trinket1']) ? 'text-quality-' + profileData.items['trinket1'].quality : ''}>{(profileData.items['trinket1']) ? profileData.items['trinket1'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                                ...
                                <div className="item"><a href={(profileData.items['trinket2']) ? this.getItemLink(profileData.items['trinket2']) : ""}>
                                    <div className={(profileData.items['trinket2']) ? 'item-img img-quality-' + profileData.items['trinket2'].quality : 'item-img'}
                                    ...
                                    <div className="item-info d-none d-md-block">
                                        <div className="item-name">
                                            <h3><span className={(profileData.items['trinket2']) ? 'text-quality-' + profileData.items['trinket2'].quality : ''}>{(profileData.items['trinket2']) ? profileData.items['trinket2'].name : ''}</span></h3>
                                        </div>
                                        <div className="item-level">
                        ...
                        <div className="centered-items-group">
                            <div className="item left-item">
                                <div className="item-info d-none d-md-block">
                                    <div className="item-name">
                                        <h3><span className={(profileData.items['mainHand']) ? 'text-quality-' + profileData.items['mainHand'].quality : ''}>{(profileData.items['mainHand']) ? profileData.items['mainHand'].name : ''}</span></h3>
                                    </div>
                                    <div className="item-level">
                                ...
                                <a href={(profileData.items['mainHand']) ? this.getItemLink(profileData.items['mainHand']) : ""}>
                                    <div className={(profileData.items['mainHand']) ? 'item-img img-quality-' + profileData.items['mainHand'].quality : 'item-img'}
                            ...
                            <div className="item right-item"><a href={(profileData.items['offHand']) ? this.getItemLink(profileData.items['offHand']) : ""}>
                                <div className={(profileData.items['offHand']) ? 'item-img img-quality-' + profileData.items['offHand'].quality : 'item-img'}
                                ...
                                <div className="item-info d-none d-md-block">
                                    <div className="item-name">
                                        <h3><span className={(profileData.items['offHand']) ? 'text-quality-' + profileData.items['offHand'].quality : ''}>{(profileData.items['offHand']) ? profileData.items['offHand'].name : ''}</span></h3>
                                    </div>
                                    <div className="item-level">
